A numerical python interface to the berkeley database.  This is very useful
in combination with a higher level manager such as [pycolumns](http://code.google.com/p/pycolumns/). pycolumns has a higher level interface that allows querying and comparison of "columns", each of which is indexed using numpydb.
